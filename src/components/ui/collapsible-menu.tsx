    ...
    <div className="mb-2 min-h-[48px] list-none last:mb-0">
      {dropdownItems?.length ? (
        ...
        <ActiveLink
          ...
          target={href.startsWith('http') ? '_blank' : undefined} // added target prop based on href
          rel={href.startsWith('http') ? 'noopener noreferrer' : undefined} // added rel prop based on href
          className={cn(
