...
export default function SingleNftComparisonChart() {
  ...
  const { nft } = useSelector((state: RootState) => state.PORTFOLIO);
  const Nft = nft[0];
            ...
            <span className="flex items-center gap-2.5">
              <span className="flex flex-row items-center gap-2.5">
                <img
                  ...
                  src={Nft?.listing.currencyContractAddress.Symbol}
                />
              </span>
              ...
              <span className="text-sm text-gray-400">
                ({Nft?.listing.currencyValuePerToken.name})
              </span>
            </span>
