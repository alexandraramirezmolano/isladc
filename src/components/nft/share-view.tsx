...
export default function ShareView({ nftUrl }: ShareViewProps) {
  let [copyButtonStatus, setCopyButtonStatus] = useState('Copiar');
  let [_, copyToClipboard] = useCopyToClipboard();
  const handleCopyToClipboard = () => {
    copyToClipboard(nftUrl);
    setCopyButtonStatus('Copiado!');
    setTimeout(() => {
      setCopyButtonStatus('Copiar');
    }, 1000);
  };
