...
import NftsRetroDrawer from '@/components/cryptocurrency-pricing-table/nfts-retro-drawer';
import { onChangeNft } from '@/app/features/portfolioMachine';
import { useDispatch } from 'react-redux';

function NftDrawerTable({
  // @ts-ignore
  columns,
  // @ts-ignore
  data,
  ...
  return (
    <>
                    ...
                    {page.map((row, idx) => {
                      ...
                      return (
                        <tr
                          ...
                          onClick={() => [
                            setIsOpen(true),
                            dispatch(onChangeNft([row.original])),
                          ]} //Here the user choose the Nft's pool that want to see
                        >
      ...
      {/*<NftsRetroDrawer isOpen={isOpen} setIsOpen={setIsOpen} />*/}
    </>
  );
}

export default NftDrawerTable;
