...
import SingleNftComparisonChart from '@/components/ui/chats/single-nft-comparision-chart';
import Scrollbar from '@/components/ui/scrollbar';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '@/app/store';
import { onChangeNft } from '@/app/features/portfolioMachine';

interface NftsDrawerProps {
  isOpen: boolean;
  setIsOpen: (isOpen: boolean) => void;
}

function NftsRetroDrawer({ isOpen, setIsOpen }: NftsDrawerProps) {
            ...
            <div className="h-full w-full">
              <div className="flex h-16 items-center justify-between gap-6 border-b border-dashed border-gray-200 px-4 dark:border-gray-700 sm:px-6">
                ...
                <Button
                  ...
                  variant="transparent"
                  size="small"
                  onClick={() => [setIsOpen(false), dispatch(onChangeNft([]))]}
                >
...
export default NftsRetroDrawer;
